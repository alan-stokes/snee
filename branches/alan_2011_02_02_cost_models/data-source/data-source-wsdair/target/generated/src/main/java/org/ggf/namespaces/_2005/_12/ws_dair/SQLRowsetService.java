...
@WebServiceClient(name = "SQLRowsetService", 
                  wsdlLocation = "file:/home/S06/stokesa6/PHD/Dropbox/SNEE_Cost_Models/SNEE/data-source/data-source-wsdair/target/wsdl/wsdair/sqlrowset_service_service.wsdl",
...
public class SQLRowsetService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/S06/stokesa6/PHD/Dropbox/SNEE_Cost_Models/SNEE/data-source/data-source-wsdair/target/wsdl/wsdair/sqlrowset_service_service.wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:/home/S06/stokesa6/PHD/Dropbox/SNEE_Cost_Models/SNEE/data-source/data-source-wsdair/target/wsdl/wsdair/sqlrowset_service_service.wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
