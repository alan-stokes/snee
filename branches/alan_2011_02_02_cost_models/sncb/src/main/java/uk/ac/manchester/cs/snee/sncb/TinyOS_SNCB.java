...
public abstract class TinyOS_SNCB
{
  protected Logger logger = Logger.getLogger(TinyOS_SNCB_TelosB.class.getName());
  ...
  protected void pause() throws SNCBException {
    if (!isStarted) return;
...
//    mr.pause();
  ...
  protected void resume() throws SNCBException {
    if (!isStarted) return;
